...
class StackedHourglass(nn.Module):
    ...
    def forward(self, inputs, out_size):
        ...
        hourglass1_out1, hourglass1_out3, hourglass1_out4 = self.hourglass1(conv1_out, scale1=None, scale2=None, scale3=None)
        hourglass1_out1, hourglass1_out3, hourglass1_out4 = self.hourglass1(conv1_out, scale1=None, scale2=hourglass1_out1, scale3=conv1_out)
        ...
        prob1 = F.softmax(-cost1, dim=1)  # [B, D, H, W]在视差维度归一化
...
class DisparityRegression(nn.Module):
    ...
    def forward(self, prob):
        ...
        out = torch.sum(disp_score * prob, dim=1)  # [B, H, W] 在D维上，视差0-Maxdisap对应乘上相应概率，求和，即得可能的视差数值
        return out
