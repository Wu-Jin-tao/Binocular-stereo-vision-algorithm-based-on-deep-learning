...
parser.add_argument('--left', default='left.png', help='path to the left image')
parser.add_argument('--right', default='right.png', help='path to the right image')
parser.add_argument('--model-path', default='checkpoint/best_model.pt', help='path to the model')
parser.add_argument('--save-path', default='1.png', help='path to save the disp image')
...
def main():
    ...
    transform = T.Compose([Normalize(mean, std), ToTensor(), Pad(384, 464)])
